function operacion() {
  ...
  var resta1 = (x1 * x2) - (x2 * x1);
  var resta2 = (y1 * x2) - (y2 * x1);
  var resta3 = (r1 * x2) - (r2 * x1);
  ...
  if (resta1 == 0) {
    ...
    if ((x1 * x) + (y1 * y) == r1) {
      ...
      var step3 = "Paso 3: pasamos el multiplicador de Y, dividiendo el resultado ('=') de la funcion. -->  (" + resta3 + " / " + resta2 + ")" ;
      var step4 = "Paso 4: deducimos que la Y es igual a " + y + ". --> Y = " + y + "";
      var step5 = "Paso 5: sustituimos la y de una de las funciones por: " + y + ". --> (" + y1 + " * " + y + ")";
      var step6 = "Paso 6: le restamos a X el resultado de la multiplicacion anterior. --> " + r1 + " - " + mult + "";
